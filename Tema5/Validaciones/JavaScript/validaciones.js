...
function comprobarIBAN(codIbanOr){
  ...
  let posi;
  console.log(controletra);
  console.log(controlNumero);
  codIBAN = codIBAN.slice(4);
  console.log(codIBAN);
  
  for(i=0;i<controletra.length;i++){
    if(letras.includes(controletra[i])){
      posi = 10 + letras.indexOf(controletra[i]);
      console.log(posi);
      codIBAN = codIBAN + posi;
    }
  }
